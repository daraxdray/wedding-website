            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-2 col-md-6 col-6">
                <div className="navbar-header">
                  <Link className="navbar-brand logo" to='/'><small>{AppConfig.preTitle}</small>{AppConfig.title}<span><i
                ...
                <div id="navbar" className="collapse navbar-collapse navigation-holder">
                  ...
                  <ul className="nav navbar-nav mb-2 mb-lg-0">
                    <li className="menu-item-has-children">
                      ...
                      {AppConfig.isVisible.homeSubLink &&  <ul className="sub-menu">
                    ...
                    <li className="menu-item-has-children">
                      { AppConfig.isVisible.gallery  && <Link onClick={ClickHandler} to="/gallery">Gallery</Link>}
                      {AppConfig.isVisible.gallerySub && <ul className="sub-menu">
                    ...
                    { AppConfig.isVisible.pages  && <li className="menu-item-has-children">
                    ...
                    {AppConfig.isVisible.blog && <li className="menu-item-has-children">
                      <Link onClick={ClickHandler} to="/blog">Blog</Link>
                      {AppConfig.isVisible.blogSub && <ul className="sub-menu">
