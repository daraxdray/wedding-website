            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-2 col-md-6 col-6">
                <div className="navbar-header">
                  <NavLink className="navbar-brand logo" to='/'><small>{AppConfig.preTitle}</small>{AppConfig.title}<span><i
              ...
              <div className="col-lg-2 col-md-2 col-2">
                <div className="header-right">
                  <button className="theme-btn" onClick={()=>openWelcomeModal()}><span className="text">Attend Now </span> <span className="mobile">
